...
func init() {
	...
	transactionDescTransactionID := transactionFields[3].Descriptor()
	...
	transactionDescFrom := transactionFields[6].Descriptor()
	...
	transactionDescTo := transactionFields[7].Descriptor()
	...
	transactionDescPayload := transactionFields[9].Descriptor()
	...
	transactionDescState := transactionFields[10].Descriptor()
	...
	transactionDescDeletedAt := transactionFields[13].Descriptor()
