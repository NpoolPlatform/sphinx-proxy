...
var (
	...
	TransactionsColumns = []*schema.Column{
		...
		{Name: "coin_type", Type: field.TypeInt8, Default: 0},
		{Name: "transaction_id_insite", Type: field.TypeString, Default: ""},
		{Name: "from", Type: field.TypeString, Default: ""},
		{Name: "to", Type: field.TypeString, Default: ""},
		{Name: "value", Type: field.TypeFloat64, Default: 0},
		{Name: "state", Type: field.TypeEnum, Enums: []string{"wait", "done", "fail"}},
